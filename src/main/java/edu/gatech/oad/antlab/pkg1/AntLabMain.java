 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Simon Moreno");
		  toPrint += p1.toString("smoreno9");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Vishrut Nanda");
		  toPrint += p2.toString("vnanda8");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Matias Szylkowski");
		  toPrint += p3.toString("mszylkowski3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Nikolas Preza");
                  toPrint += p4.toString("npreza3");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Kristofer Preza");
                  toPrint += p5.toString("kpreza3");
